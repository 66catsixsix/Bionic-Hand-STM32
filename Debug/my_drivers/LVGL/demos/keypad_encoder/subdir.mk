...
C_DEPS += \
./my_drivers/LVGL/demos/keypad_encoder/lv_demo_keypad_encoder.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/demos/keypad_encoder/%.o my_drivers/LVGL/demos/keypad_encoder/%.su my_drivers/LVGL/demos/keypad_encoder/%.cyclo: ../my_drivers/LVGL/demos/keypad_encoder/%.c my_drivers/LVGL/demos/keypad_encoder/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-demos-2f-keypad_encoder

clean-my_drivers-2f-LVGL-2f-demos-2f-keypad_encoder:
	-$(RM) ./my_drivers/LVGL/demos/keypad_encoder/lv_demo_keypad_encoder.cyclo ./my_drivers/LVGL/demos/keypad_encoder/lv_demo_keypad_encoder.d ./my_drivers/LVGL/demos/keypad_encoder/lv_demo_keypad_encoder.o ./my_drivers/LVGL/demos/keypad_encoder/lv_demo_keypad_encoder.su

.PHONY: clean-my_drivers-2f-LVGL-2f-demos-2f-keypad_encoder
