...
C_SRCS += \
../my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.c 

OBJS += \
./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.o 

C_DEPS += \
./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/draw/nxp/%.o my_drivers/LVGL/src/draw/nxp/%.su my_drivers/LVGL/src/draw/nxp/%.cyclo: ../my_drivers/LVGL/src/draw/nxp/%.c my_drivers/LVGL/src/draw/nxp/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-nxp

clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-nxp:
	-$(RM) ./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.cyclo ./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.d ./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.o ./my_drivers/LVGL/src/draw/nxp/lv_gpu_nxp.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-nxp
