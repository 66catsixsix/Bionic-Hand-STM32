...
C_DEPS += \
./my_drivers/LVGL/src/extra/layouts/grid/lv_grid.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/extra/layouts/grid/%.o my_drivers/LVGL/src/extra/layouts/grid/%.su my_drivers/LVGL/src/extra/layouts/grid/%.cyclo: ../my_drivers/LVGL/src/extra/layouts/grid/%.c my_drivers/LVGL/src/extra/layouts/grid/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid

clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid:
	-$(RM) ./my_drivers/LVGL/src/extra/layouts/grid/lv_grid.cyclo ./my_drivers/LVGL/src/extra/layouts/grid/lv_grid.d ./my_drivers/LVGL/src/extra/layouts/grid/lv_grid.o ./my_drivers/LVGL/src/extra/layouts/grid/lv_grid.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid
