...
C_SRCS += \
../my_core/ui/lvgl_motor.c \
../my_core/ui/main_screen.c 

OBJS += \
./my_core/ui/lvgl_motor.o \
./my_core/ui/main_screen.o 

C_DEPS += \
./my_core/ui/lvgl_motor.d \
./my_core/ui/main_screen.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_core/ui/%.o my_core/ui/%.su my_core/ui/%.cyclo: ../my_core/ui/%.c my_core/ui/subdir.mk
...
clean: clean-my_core-2f-ui

clean-my_core-2f-ui:
	-$(RM) ./my_core/ui/lvgl_motor.cyclo ./my_core/ui/lvgl_motor.d ./my_core/ui/lvgl_motor.o ./my_core/ui/lvgl_motor.su ./my_core/ui/main_screen.cyclo ./my_core/ui/main_screen.d ./my_core/ui/main_screen.o ./my_core/ui/main_screen.su

.PHONY: clean-my_core-2f-ui
