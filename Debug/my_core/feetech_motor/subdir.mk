...
OBJS += \
./my_core/feetech_motor/feetech_motor.o 

C_DEPS += \
./my_core/feetech_motor/feetech_motor.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_core/feetech_motor/%.o my_core/feetech_motor/%.su my_core/feetech_motor/%.cyclo: ../my_core/feetech_motor/src/%.c my_core/feetech_motor/subdir.mk
...
clean: clean-my_core-2f-feetech_motor

clean-my_core-2f-feetech_motor:
	-$(RM) ./my_core/feetech_motor/feetech_motor.cyclo ./my_core/feetech_motor/feetech_motor.d ./my_core/feetech_motor/feetech_motor.o ./my_core/feetech_motor/feetech_motor.su

.PHONY: clean-my_core-2f-feetech_motor
