...
C_DEPS += \
./my_drivers/LVGL/demos/stress/lv_demo_stress.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/demos/stress/%.o my_drivers/LVGL/demos/stress/%.su my_drivers/LVGL/demos/stress/%.cyclo: ../my_drivers/LVGL/demos/stress/%.c my_drivers/LVGL/demos/stress/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-demos-2f-stress

clean-my_drivers-2f-LVGL-2f-demos-2f-stress:
	-$(RM) ./my_drivers/LVGL/demos/stress/lv_demo_stress.cyclo ./my_drivers/LVGL/demos/stress/lv_demo_stress.d ./my_drivers/LVGL/demos/stress/lv_demo_stress.o ./my_drivers/LVGL/demos/stress/lv_demo_stress.su

.PHONY: clean-my_drivers-2f-LVGL-2f-demos-2f-stress
