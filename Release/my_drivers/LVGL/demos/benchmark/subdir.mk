...
C_DEPS += \
./my_drivers/LVGL/demos/benchmark/lv_demo_benchmark.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/demos/benchmark/%.o my_drivers/LVGL/demos/benchmark/%.su my_drivers/LVGL/demos/benchmark/%.cyclo: ../my_drivers/LVGL/demos/benchmark/%.c my_drivers/LVGL/demos/benchmark/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-demos-2f-benchmark

clean-my_drivers-2f-LVGL-2f-demos-2f-benchmark:
	-$(RM) ./my_drivers/LVGL/demos/benchmark/lv_demo_benchmark.cyclo ./my_drivers/LVGL/demos/benchmark/lv_demo_benchmark.d ./my_drivers/LVGL/demos/benchmark/lv_demo_benchmark.o ./my_drivers/LVGL/demos/benchmark/lv_demo_benchmark.su

.PHONY: clean-my_drivers-2f-LVGL-2f-demos-2f-benchmark
