...
C_DEPS += \
./my_drivers/LVGL/src/extra/widgets/list/lv_list.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/extra/widgets/list/%.o my_drivers/LVGL/src/extra/widgets/list/%.su my_drivers/LVGL/src/extra/widgets/list/%.cyclo: ../my_drivers/LVGL/src/extra/widgets/list/%.c my_drivers/LVGL/src/extra/widgets/list/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-list

clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-list:
	-$(RM) ./my_drivers/LVGL/src/extra/widgets/list/lv_list.cyclo ./my_drivers/LVGL/src/extra/widgets/list/lv_list.d ./my_drivers/LVGL/src/extra/widgets/list/lv_list.o ./my_drivers/LVGL/src/extra/widgets/list/lv_list.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-list
