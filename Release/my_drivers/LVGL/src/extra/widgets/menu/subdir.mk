...
C_DEPS += \
./my_drivers/LVGL/src/extra/widgets/menu/lv_menu.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/extra/widgets/menu/%.o my_drivers/LVGL/src/extra/widgets/menu/%.su my_drivers/LVGL/src/extra/widgets/menu/%.cyclo: ../my_drivers/LVGL/src/extra/widgets/menu/%.c my_drivers/LVGL/src/extra/widgets/menu/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-menu

clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-menu:
	-$(RM) ./my_drivers/LVGL/src/extra/widgets/menu/lv_menu.cyclo ./my_drivers/LVGL/src/extra/widgets/menu/lv_menu.d ./my_drivers/LVGL/src/extra/widgets/menu/lv_menu.o ./my_drivers/LVGL/src/extra/widgets/menu/lv_menu.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-menu
