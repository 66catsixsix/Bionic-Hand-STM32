...
C_DEPS += \
./my_drivers/LVGL/src/extra/layouts/flex/lv_flex.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/extra/layouts/flex/%.o my_drivers/LVGL/src/extra/layouts/flex/%.su my_drivers/LVGL/src/extra/layouts/flex/%.cyclo: ../my_drivers/LVGL/src/extra/layouts/flex/%.c my_drivers/LVGL/src/extra/layouts/flex/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-flex

clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-flex:
	-$(RM) ./my_drivers/LVGL/src/extra/layouts/flex/lv_flex.cyclo ./my_drivers/LVGL/src/extra/layouts/flex/lv_flex.d ./my_drivers/LVGL/src/extra/layouts/flex/lv_flex.o ./my_drivers/LVGL/src/extra/layouts/flex/lv_flex.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-flex
