...
C_DEPS += \
./my_drivers/LVGL/src/extra/lv_extra.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/extra/%.o my_drivers/LVGL/src/extra/%.su my_drivers/LVGL/src/extra/%.cyclo: ../my_drivers/LVGL/src/extra/%.c my_drivers/LVGL/src/extra/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-extra

clean-my_drivers-2f-LVGL-2f-src-2f-extra:
	-$(RM) ./my_drivers/LVGL/src/extra/lv_extra.cyclo ./my_drivers/LVGL/src/extra/lv_extra.d ./my_drivers/LVGL/src/extra/lv_extra.o ./my_drivers/LVGL/src/extra/lv_extra.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-extra
