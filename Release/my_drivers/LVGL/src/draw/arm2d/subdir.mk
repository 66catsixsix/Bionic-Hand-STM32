...
C_SRCS += \
../my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.c 

OBJS += \
./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.o 

C_DEPS += \
./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.d 


# 每个子目录必须为构建它所贡献的源提供规则
my_drivers/LVGL/src/draw/arm2d/%.o my_drivers/LVGL/src/draw/arm2d/%.su my_drivers/LVGL/src/draw/arm2d/%.cyclo: ../my_drivers/LVGL/src/draw/arm2d/%.c my_drivers/LVGL/src/draw/arm2d/subdir.mk
...
clean: clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-arm2d

clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-arm2d:
	-$(RM) ./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.cyclo ./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.d ./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.o ./my_drivers/LVGL/src/draw/arm2d/lv_gpu_arm2d.su

.PHONY: clean-my_drivers-2f-LVGL-2f-src-2f-draw-2f-arm2d
